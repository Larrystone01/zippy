    ...
    <div className="lux-shell">
      ...
      <div className="grid gap-8 lg:grid-cols-[1.04fr_0.96fr]">
        ...
        <form onSubmit={submit} className="lux-card flex flex-col gap-4 p-5">
          {!user && (
            <div className="rounded-2xl border border-[#e7dece] bg-[#fffdf9] p-5">
              <div className="mb-4">
                <p className="lux-label">Guest Details</p>
                <h2 className="mt-1 text-lg font-semibold text-[#17130f]">
                  Tell us about yourself
                </h2>
                <p className="mt-1 text-sm text-[#6f6253]">
                  We'll use these details to contact you about your delivery.
                  You'll need to create an account with this email later if
                  you'd like to track this order.
                </p>
              </div>
          ...
          <div>
            <p className="lux-label">Recipient Details</p>
          ...
          <div>
            <label className="lux-label">Package size</label>
